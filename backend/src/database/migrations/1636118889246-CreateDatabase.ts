...
export default class CreateDatabase1636118889246 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "projects_users_users" ("project_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_d440d3d6456b48050ebda33428c" PRIMARY KEY ("project_id", "user_id"))`,
    );
    await queryRunner.query(
    ...
    // await queryRunner.query(
    //   `CREATE TABLE "menu" ("id" SERIAL NOT NULL, "children" integer , "title" character varying NOT NULL, "icon" character varying , "url" character varying NOT NULL, "order" integer NOT NULL, "profiles" integer NOT NULL, CONSTRAINT "PK_35b2a8f47d153ff7a41860cceeb" PRIMARY KEY ("id"))`,
    // );
    await queryRunner.query(
